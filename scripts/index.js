...
const cardNameInput = popupAddCard.querySelector('.popup__text-input_card-name'); //инпут названия новой карточки
const cardLinkInput = popupAddCard.querySelector('.popup__text-input_card-link'); //инпут ссылки для обложки новой карточки
